...
if (isset ($_POST['sendmail']) || $_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if ($_POST['bot_detector'] == '') {
    ...
    $data .= '<tr>
            ...
            <tr>
            <td style="border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left; font-size:15px; font-weight: 500;">Privacy & Policy | Terms & Conditions<td>
                <td style=" border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left; font-size:15px">' . $privacy_policy . '</td>
            </tr>
            <tr>
                <td style="border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left; font-size:15px; font-weight: 500;">Policy Checked<td>
                <td style=" border: 1px solid black; border-collapse: collapse; padding: 15px; text-align: left; font-size:15px">' . $policy . '</td>
            </tr>
            ';
    $data .= '</table>';
    ...
    $mail->addCC('ali.raza@niversetech.com');
    $mail->addCC('nabiha@coredigitals.biz');
      ...
      if ($mail->send()) {
        ...
        $_SESSION['api_code_executed'] = false;
        ...
        if ($_SESSION['api_code_executed'] == false) {
          ...
          $source = isset ($_SESSION['url']) ? $_SESSION['url'] : '-';
        ...
        header("Location: /thankyou.php?name=$urlData");
      }
    } catch (Exception $e) {
