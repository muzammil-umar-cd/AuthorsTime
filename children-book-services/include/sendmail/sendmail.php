...
if (isset($_POST['sendmail'])) {
    ...
    if($_POST['bot_detector'] == ''){
        ...
        $data = '<h1 style="color: #01163A;text-align: center;">AuthorsTime Lead</h1><table style="width:100%; border: 1px solid black; border-collapse: collapse;">';
            $data .= '<tr>
      ...
      try {
       ...
       $mail->addCC('kashan@niversetech.com');
        ...
        if ($mail->send()) {
          ...
          header("Location: /children-book-services/thankyou.php?name=$urlData");
        }
      } catch (Exception $e) {
