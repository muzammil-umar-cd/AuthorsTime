...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h1>
                            <span>BEST BOOK PUBLISHING SERVICES</span> AT AFFORDABLE PRICES!
                        </h1>
                        <p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="heading">
                            <h3>We offer a</h3>
                            <h2>Comprehensive Range of <span>Publishing</span> Services</h2>
                            <p>
        ...
        <section class="personal-book">
            <div class="container">
                <div class="heading text-center">
                    <h3>Here's what</h3>
                    <h2>Our <span>Publishing</span> Services Entail</h2>
                    <p>
    ...
    <!-- ZENDESK -->
    <script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=deb550d6-f418-45fd-967d-c97d0660281e"> </script>
    <!-- ZENDESK -->
    <script>
    $(document).ready(() => {
