            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="text-box">
                     ...
                     <p>Our book marketing services let you witness uncountable benefits like fame, sales, and a better identity in literary circles. Hire now!</p>
                  </div>
               </div>
            </div>
            <div class=" row form-row-box">
                     ...
                     <div class="footer-form ">
                        ...
                        <div class=" ">
                           <div class="col-sm-12 p0">
                              <textarea placeholder="Message" name="message" rows="5" required="required"></textarea>
                           </div>
                           <div class="col-sm-12 p0">
               ...
               <div class="col-sm-3">
                  <div class="contect-box">
                     <ul>
                        <li><i class="fa fa-phone" aria-hidden="true"></i><span><a href="tel:(929) 379-9764">Call Us: (929) 379-9764</a></span></li>

                        <li><a href="mailto:info@authorstime.com"><i class="fa fa-envelope" aria-hidden="true"></i> </span>info@authorstime.com</a></li>
                        
                        <li><a href="javascript:;"><i class="fa fa-address-book" aria-hidden="true"></i><p> 112 West 34th Street 18th & 17th Floors 10120 New York United States
                          </p></a></li>
                     </ul>
                  </div>
               </div>
