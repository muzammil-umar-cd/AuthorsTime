            ...
            <div class="col-sm-6 banner-before-img ">
                <div class="banner-main">
                    <div class="banner-text">
                        ...
                        <p>Do you want to be among thousands of individuals who have taken advantage of book marketing
                            services? We offer valuable book promotion services at a competitive market rate.</p>
                    </div>
                </div>
                ...
                <div class=" header-btn visible-xs">
                    <a href="tel:844-903-5691" class="phone-btn"><i class="fa fa-phone-square" aria-hidden="true"></i>
                        Call Us: 844-903-5691</a>
                </div>
            </div>
                ...
                <div class="inner-banner-form-main">
                    <div class="inner-banner-form">
                        ...
                        <form action="../sendmail/send_mail_lp1.php" method="POST">
                            ...
                            <button type="submit" name="send_reserve_req" class="btn-submit">
                                Submit!
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="text-box">
                    ...
                    <p>Are you wondering how book marketing can change the fate of your literary accumulations? Whether
                        it is an academic edition, a non-fiction work, a collection of poetry, or a series of fictional
                        novels – we know how to make way for your book to reach the right readers.</p>
                </div>
                ...
                <div class="header-btn">
                    <a href="javascript:;" class="yellow_btn popup-btn"
                        onclick="if (!window.__cfRLUnblockHandlers) return false; order_now_value(this)" name="for $199"
                        data-cf-modified-b18c94f00f31496250def299-="">Request a Quote</a>
                    <a href="javascript:;" class="phone-btn chats">
                        <!-- <img loading="lazy" src="images/flg-icon.png"> -->Live Chat
                    </a>
                </div>
            </div>
...
<section class="cta-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="header-btn">
                    <a href="tel:(929) 379-9764" class="phone-btn"><i class="fa fa-phone-square" aria-hidden="true"></i>
                        Call Us: (929) 379-9764</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="port-text wow zoomIn" data-wow-delay="300ms">
                    ...
                    <p>Authors Time are pioneers of book promotion and marketing, where our aim is to level the playing
                        field for our clients. Now beat the bestseller novels and renowned authors with our
                        extraordinary book marketing services. </p>
                </div>
            </div>
                ...
                <div class="client-test-slider">
                    <div class="col-sm-12">
                        <div class="client-testi-box">
                            ...
                            <p class="testi-pera">Every author like to be praised for their published work. The book
                                marketing by this agency is helping me immensely to reach ideal book purchasers. I will
                                recommend it to aspiring authors and poets. </p>
                    ...
                    <div class="col-sm-12">
                        <div class="client-testi-box">
                            ...
                            <p class="testi-pera">My book was unable to gain momentum in the mainstream public. The book
                                promotion of Authors Time allowed me to navigate my way in the market. Now, I will be
                                choosing for my upcoming book as well. </p>
                            <div class="testi-flex-box">
                                <div class="testi-flex-box">
                                    <div class="cli-testi-text">
                                        <h3>Walter Keith</h3>
                    ...
                    <div class="col-sm-12">
                        <div class="client-testi-box">
                            ...
                            <p class="testi-pera">I always dreamt of becoming a published author, but I did not see any
                                luck with my book. A friend suggested Authors Time for book marketing. Surprisingly, it
                                did wonders. Now my book is well-read, well-sold, and well-appreciated. </p>
                            <div class="testi-flex-box">
                                <div class="testi-flex-box">
                                    <div class="cli-testi-text">
                                        <h3>Laura Welton</h3>
                        ...
                        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                            <div class="panel panel-default wow fadeInLeft" data-wow-duration="4s">
                                ...
                                <div id="collapseOne" class="panel-collapse collapse " role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        Book marketing is a presentation and promotional approach that focuses on
                                        creating awareness for a particular book among booksellers and consumers.
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default wow fadeInLeft" data-wow-duration="4s">
                                ...
                                <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        The goal of marketing is to generate book sales, establish the identity of the
                                        author, build positive imagery of a literary piece, and provoke interest in
                                        individuals.
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default wow fadeInLeft" data-wow-duration="4s">
                                ...
                                <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        Authors Time applies schemes that help a book become visible in the literary
                                        world and further its appeal to the masses, including bibliophiles and other
                                        stakeholders.
                                    </div>
                                </div>
                            </div>
                            <div class="panel panel-default wow fadeInLeft" data-wow-duration="4s">
                                ...
                                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel"
                                    ...
                                    <div class="panel-body">
                                        Customers like feeling valued, whether through promotional content or direct
                                        interactions. Our book publicity involves several practices to endorse the book
                                        of our client.
                                    </div>
                                </div>
                            </div>
